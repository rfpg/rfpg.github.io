...
p.nominalBounds = new cjs.Rectangle(-6.8,-6.8,241.70000000000002,105.6);
...
}).prototype = getMCSymbolPrototype(lib.node, new cjs.Rectangle(-1,-1,14.5,14.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.txt.name = "txt";
	this.txt.setTransform(344.2,-12);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.CachedBmp_5163();
...
if (reversed == null) { reversed = false; }
	...
	// Draw_Curve
	this.text = new cjs.Text("Plot", "bold 63px 'Verdana'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 79;
	this.text.lineWidth = 310;
	this.text.parent = this;
	this.text.setTransform(1635.25,1646.45);

	this.plot = new lib.plot();
	this.plot.name = "plot";
	this.plot.setTransform(1635.2,1690.45,1,1,0,0,0,114,46);
...
p.nominalBounds = new cjs.Rectangle(799.9,1581.5,992.4,974.1999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/plus_slider_atlas_1.png?1651498192292", id:"plus_slider_atlas_1"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1651498192327", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1651498192327", id:"sdk/anwidget.js"},
		{src:"components/ui/src/textinput.js?1651498192327", id:"an.TextInput"}
	],
	preloads: []
};
